...
class MyWindow(QMainWindow): 
    ...
    def __init__(self, parent): 
        ...
        # Button to print "42" to the console 
        self.btn_console = QPushButton("42") 
        self.btn_console.clicked.connect(lambda: print("42")) 
        self.my_layout.addWidget(self.btn_console) 
